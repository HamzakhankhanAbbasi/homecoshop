				...
				<div class="row">
					<div class="col-lg-6 col-md-6 col-sm-6 col-12 p-0">
						<div class="int_bread_crumbs">
							<h1>Decorative Vanities</h1>
						</div>
					</div>
					<div class="col-lg-6 col-md-6 col-sm-6 col-12 p-0">
						<div class="int_home_crumbs">
							<ul>
								<li><a href="index2.html">Home // </a><span> Decorative Vanities</span></li>
							</ul>
						</div>
					</div>
				</div>
			...
			<div class="container">
				<div class="row">
							...
							<div class="int_sidebar_box recent_blog_one">
								...
								<div class="int_blog_category_mini">
									<ul>
										...
										<path fill-rule="evenodd"  fill="rgb(255, 29, 77)"
										...
										<path fill-rule="evenodd"  fill="rgb(255, 29, 77)"
										 d="M0.038,4.720 L6.164,4.710 C6.558,4.710 6.878,4.392 6.878,3.999 L6.878,2.016 L9.967,3.999 L5.777,6.688 C5.445,6.901 5.349,7.342 5.563,7.673 C5.777,8.004 6.219,8.099 6.551,7.886 L11.673,4.597 C11.877,4.466 12.000,4.241 12.000,3.999 C12.000,3.756 11.877,3.531 11.673,3.400 L6.551,0.112 C6.331,-0.030 6.051,-0.040 5.822,0.085 C5.592,0.210 5.449,0.449 5.449,0.710 L5.449,3.286 L0.000,3.286 "/>
										</svg> Storage & Shelving </a><span>( 390 )</span></li>
										<li><a href="javascript:;"><svg 
										 xmlns="http://www.w3.org/2000/svg"
										 width="12px" height="8px">
										<path fill-rule="evenodd"  fill="rgb(255, 29, 77)"
								...
								<div class="int_blog_category_mini">
									<ul>
										...
										<div class="int_checkbox">
										  ...
										  <label for="auth_remember2">20% or More</label>
										</div>
										<span>( 16 )</span></li>
										<li>
										<div class="int_checkbox">
					...
					<div class="col-lg-9 col-md-8 col-sm-12">
						<div class="product_list_filter list_filter">
							<ul>
								<li>
									<select>
										<option value="">You're looking for: Everything</option>
								...
								<li>
									<div class="product_item_block">
										<div class="grid-item">
											<div class="product_grid">
												<div class="product_item">
													<img src="assets/images/product/pro8.png" alt="product-img"/>
										...
										<div class="content_block">
											...
											<a href="product-single-white.html" class="int_btn int_btn_two">more info</a>
										</div>
									</div>
								</li>
								<li>
									<div class="product_item_block">
										<div class="grid-item">
											<div class="product_grid">
												<div class="product_item">
													<img src="assets/images/product/pro2.png" alt="product-img"/>
													<div class="product_ovr_links">
														<ul>
															<li>
																<a href="shop.php">
								...
								<li>
									<div class="product_item_block">
										<div class="grid-item">
											<div class="product_grid">
												<div class="product_item">
													<img src="assets/images/product/pro3.png" alt="product-img"/>
													<div class="product_ovr_links">
														<ul>
															<li>
																<a href="shop.php">
								...
								<li>
									<div class="product_item_block">
										<div class="grid-item">
											<div class="product_grid">
												<div class="product_item">
													<img src="assets/images/product/pro4.png" alt="product-img"/>
								...
								<li>
									<div class="product_item_block">	
										<div class="grid-item">	
											<div class="product_grid">
												<div class="product_item">
													<img src="assets/images/product/pro6.png" alt="product-img"/>
													<div class="product_ovr_links">
														<ul>
															<li>
																<a href="shop.php">
								...
								<li>
									<div class="product_item_block">	
										<div class="grid-item">	
											<div class="product_grid">
												<div class="product_item">
													<img src="assets/images/product/pro7.png" alt="product-img"/>
													<div class="product_ovr_links">
														<ul>
															<li>
																<a href="shop.php">
								...
								<li>
									<div class="product_item_block">
										<div class="grid-item">
											<div class="product_grid">
												<div class="product_item">
													<img src="assets/images/product/pro1.png" alt="product-img"/>
													<div class="product_ovr_links">
														<ul>
															<li>
																<a href="shop.php">
								...
								<li>
									<div class="product_item_block">
										<div class="grid-item">
											<div class="product_grid">
												<div class="product_item">
													<img src="assets/images/product/pro5.png" alt="product-img"/>
													<div class="product_ovr_links">
														<ul>
															<li>
																<a href="shop.php">
								...
								<li>
									<div class="product_item_block">
										<div class="grid-item">
											<div class="product_grid">
												<div class="product_item">
													<img src="assets/images/product/pro9.png" alt="product-img"/>
													<div class="product_ovr_links">
														<ul>
															<li>
																<a href="shop.php">
