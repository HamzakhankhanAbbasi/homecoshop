      ...
      <div class="row">
         ...
         <div class="col-lg-6 col-md-6 col-sm-6 col-12 p-0">
            <div class="int_home_crumbs">
               <ul>
                  <li><a href="index2.html">Home // </a><span> White Shaker</span></li>
               </ul>
            </div>
         </div>
      </div>
      ...
      <div class="tabs">
        ...
        <div class="row">     
         ...
         <div class="tab-button-outer">
            <ul id="tab-button">
               <li><a href="#tab01" class="activeTab">BASE CABINETS</a></li>
               <li><a href="#tab02" class="activeTab">WALL CABINETS</a></li>
               <li><a href="#tab03" class="activeTab">TALL CABINETS</a></li>
               <li><a href="#tab04" class="activeTab">OVEN CABINETS</a></li>
               <li><a href="#tab05" class="activeTab">ACCESSORIES</a></li>
            </ul>
         </div>
         </div>
         </div> 
